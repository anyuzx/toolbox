...
class traj:
    ...
    def get_firsttime(self):
        starttime = self.file['particles/all/c_pe/time'][0]
        endtime = self.file['particles/all/c_pe/time'][-1]
        starttimestep = self.file['particles/all/c_pe/step'][0]
        endtimestep = self.file['particles/all/c_pe/step'][-1]

        return starttime, endtime, starttimestep, endtimestep

    def get_framenumber(self):
        try:
            return self.file['particles/all/c_pe/value'].shape[0]
        except:
            raise
    ...
    def get_atomnumber(self):
        ...
        try:
            return self.file['particles/all/c_pe/value'].shape[1]
        except:
            raise

    def get_frame(self,t):
        return self.file['particles/all/c_pe/value'][t]
...
def mergetraj(filelst, foutname, stride):
    ...
    new_file.create_group('particles/all/c_pe')
    ...
    for index, fp in enumerate(filelst):
        try:
            ...
            new_file['particles/all/c_pe'].create_dataset('step', (framenum0_stride,), \
                                                               maxshape=(None,),\
                                                               dtype='i4')
            new_file['particles/all/c_pe'].create_dataset('time', (framenum0_stride,), \
                                                               maxshape=(None,),\
                                                               dtype='f8')
            ...
            new_file['particles/all/c_pe/value'][:] = traj0.file['particles/all/c_pe/value'][::stride[index]]
            new_file['particles/all/c_pe/step'][:] = traj0.file['particles/all/c_pe/step'][::stride[index]]
            new_file['particles/all/c_pe/time'][:] = traj0.file['particles/all/c_pe/time'][::stride[index]]
        ...
        # append new data
        new_file['particles/all/c_pe/value'][framenum_temp:] = traj1.file['particles/all/c_pe/value'][::stride[index]][1::]
        new_file['particles/all/c_pe/step'][framenum_temp:] = traj1.file['particles/all/c_pe/step'][::stride[index]][1::] + endtimestep0
        new_file['particles/all/c_pe/time'][framenum_temp:] = traj1.file['particles/all/c_pe/time'][::stride[index]][1::] + endtime0
