...
# parse arguments
parser = argparse.ArgumentParser(description='Compute contact life time from H5MD trajectory file.')
parser.add_argument('lammps_hdf5_dump', help='H5MD trajectory file.')
...
with h5py.File(args.lammps_hdf5_dump) as traj:
    coordinates = traj['particles/all/position/value'][:]
